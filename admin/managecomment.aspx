<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="managecomment.aspx.cs" Inherits="admin_managecontactus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="comid" DataSourceID="ObjectDataSource2">
        <Columns>
            ...
            <asp:BoundField DataField="comid" HeaderText="کدنظر" InsertVisible="False" ReadOnly="True" SortExpression="comid" />
            ...
            <asp:BoundField DataField="comemail" HeaderText="ایمیل" SortExpression="comemail" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataallcommentbydate" TypeName="commentDataSetTableAdapters.commenttblTableAdapter" UpdateMethod="Update">
        <DeleteParameters>
