<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="allowedp.aspx.cs" Inherits="allowedp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <ul class="nav nav-pills nav-justified">
			...
			<li class="nav-item">
				<a href="#" class="nav-link active">لیست مطالب تایید شده</a>
			</li>
			<li class="nav-item">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <asp:DataList ID="DataList1" runat="server" DataKeyField="postId" DataSourceID="ObjectDataSource1">
                    <ItemTemplate>                     
                      <a href="<%# Eval("postid","allowedp.aspx?postid={0}") %>">  <asp:Label ID="postnameLabel" runat="server" Text='<%# Eval("postname") %>' /> </a>
                        <br />
                        <hr>
                    </ItemTemplate>
                </asp:DataList>
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="DeletePost" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByallowed" TypeName="postDataSetTableAdapters.post_tblTableAdapter" UpdateMethod="UpdatePost">
                    <DeleteParameters>
            ...
            <div class="col-md-9">
                ...
                <asp:DataList ID="DataList2" runat="server" DataKeyField="postId" DataSourceID="ObjectDataSource2">
                    <ItemTemplate>
                        ...
                        <div class="card-footer " >
                            تاریخ ارسال:  <%# Eval("postdate") %>
                            <br/>
                            ایمیل کاربر:<%# Eval("useremail") %><br/>تعداد دانلود :  <%# Eval("postdownloaded") %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="postId" DataSourceID="ObjectDataSource3">
                    <Columns>
                        ...
                        <asp:BoundField DataField="postId" HeaderText="کد مطلب" ReadOnly="True" SortExpression="postId" />
                        ...
                        <asp:BoundField DataField="postdownloaded" HeaderText="تعداد دانلود" SortExpression="postdownloaded" />
                        <asp:BoundField DataField="file" HeaderText="فایل" SortExpression="file" />
                        <asp:BoundField DataField="postdate" HeaderText="تاریخ" SortExpression="postdate" />
