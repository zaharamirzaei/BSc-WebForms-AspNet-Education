<%@ Page Title="آموزش ها" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="amuzesha.aspx.cs" Inherits="amuzesha" %>
...
<br />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDatapostBycatID" TypeName="postDataSetTableAdapters.post_tblTableAdapter">
        <SelectParameters>
            <asp:Parameter DefaultValue="1" Name="postcat" Type="Int32" />
        </SelectParameters>
