<%@ Page Title="پروژه ها" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="projects.aspx.cs" Inherits="projects" %>
...
<br />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDatapostBycatID" TypeName="postDataSetTableAdapters.post_tblTableAdapter">
        <SelectParameters>
            <asp:Parameter DefaultValue="5" Name="postcat" Type="Int32" />
        </SelectParameters>
